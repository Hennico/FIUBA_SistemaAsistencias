...
<html>
    ...
    <body>
        <a href="#create-calendarioAcademico" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-calendarioAcademico" class="content scaffold-create" role="main">
